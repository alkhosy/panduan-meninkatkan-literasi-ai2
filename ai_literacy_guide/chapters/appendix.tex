...
\foreach \n in {1,...,75}{
    \newpage
    \section*{AI Project Canvas - Proyek \#\n}

    \begin{tcolorbox}[colback=white, colframe=black, height=9cm, title=Identifikasi Masalah]
        \textbf{Masalah apa yang ingin diselesaikan?}
        \vspace{2cm}

        \textbf{Siapa pengguna utamanya?}
        \vspace{2cm}
    \end{tcolorbox}

    \begin{tcolorbox}[colback=white, colframe=black, height=9cm, title=Solusi AI]
        \textbf{Jenis AI apa yang dibutuhkan?}
        \vspace{2cm}

        \textbf{Data apa yang diperlukan?}
        \vspace{2cm}
    \end{tcolorbox}

    \newpage
    \section*{Log Eksperimen Prompt - Proyek \#\n}

    \begin{tcolorbox}[colback=white, colframe=black, height=18cm, title=Catatan Iterasi Prompt]
        \textbf{Versi 1:}
        \vspace{3cm}
