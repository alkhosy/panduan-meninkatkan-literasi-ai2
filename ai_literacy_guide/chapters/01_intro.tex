...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.6\textwidth]{ai_literacy_guide/images/turing_test.png}
    \caption{Ilustrasi Tes Turing: Bisakah mesin menipu manusia?}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{ai_literacy_guide/images/neural_network.png}
    \caption{Arsitektur Neural Network Sederhana (Input - Hidden - Output)}
\end{figure}
